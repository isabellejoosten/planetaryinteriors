...
\begin{table}[]
	...
	\centering
		\begin{tabular}{|>{\raggedright\arraybackslash}m{0.37\columnwidth}|>{\raggedright\arraybackslash}m{0.14\columnwidth}|>{\raggedright\arraybackslash}m{0.14\columnwidth}|>{\raggedright\arraybackslash}m{0.14\columnwidth}|}
			...
			\textbf{Mass [10\textsuperscript{22} kg]} & 4.789 & 4.790 & 4.797  \\ \hline
			\textbf{Centre pressure [GPa]} & 5.140 & 4.927 & 5.209\\ \hline
			\textbf{Gravity at surface [m/s\textsuperscript{2}]} & 1.313 & 1.314 & 1.316 \\ \hline
			\textbf{Core radius [km]} & 708.4    & 662.2    & 752.4    \\ \hline
			\textbf{Shell thickness [km]}       & 121.0    & 106.8    & 123.6    \\ \hline
			\textbf{Moment of inertia [-]} & 0.344 & 0.350 & 0.341 \\ \hline
			\textbf{Mean density [kg/m\textsuperscript{3}]} & 3013 & 3012 & 3013\\ \hline
			\textbf{Iterations} & 297    & 388      & 5200    \\ \hline
		\end{tabular}%
\end{table}
\begin{figure}[H]
	\centering
...
\begin{table}[H]
	...
	\centering
		\begin{tabular}{|>{\raggedright\arraybackslash}m{0.27\columnwidth}|>{\raggedright\arraybackslash}m{0.17\columnwidth}|>{\raggedright\arraybackslash}m{0.17\columnwidth}|>{\raggedright\arraybackslash}m{0.17\columnwidth}|}
			\hline
			& \textbf{Min}    & \textbf{Mean}   & \textbf{Max}    \\ \hline
			\textbf{Mass [kg]}             & 5.625*10\textsuperscript{22} & 5.630*10\textsuperscript{22} & 5.619*10\textsuperscript{22}\\ \hline
			\textbf{Moment of inertia} & 0.351 & 0.353 & 0.350\\ \hline
			\textbf{Mean density [kg/m\textsuperscript{3}]} & 3537 & 3540 & 3534 \\ \hline
			\textbf{Iterations}                 & 5    & 5      & 5    \\ \hline
		\end{tabular}%
\end{table}
\begin{figure*}
	\centering
	\includegraphics[width=\textwidth]{model123comparison_updated.png}
...
When viewing Figure \ref{fig:123comp}, one difference between the models immediately stands out. While models I and II match almost perfectly, model III tends to compute higher values for density, pressure, and gravity. One way this could be explained is the difference in assumed layer compositions. The density calculated in the mantle is higher in all versions of model III than in the other versions. This could be because of the different mantle compositions defined in the models. The mean density found in model III is significantly higher than in models I and II. Although models I and II recalculate the layer heights based on the mean density at each iteration and model III does not, this should not affect the final mean density this much as the layer heights for model III had already been established in model II. Thus, the difference is likely caused by a difference in the way the mass is integrated in model III. This difference is also visible in the gravity and pressure plots.\\
...
\section{Conclusion}
In this report, four interior models from literature were analysed and compared to each other. Furthermore, three new models were constructed and compared to both each other and the models found in literature. These models have shown to provide a decent first estimate for the interior profile of Europa, and they roughly agree with the models found in literature, although the third model likely suffers from incorrect or incomplete input data. However, it should also be noted that there is a decent amount of uncertainty in the input values taken from literature, as well as the observational values. Future missions to Europa could provide more accurate data that can be used to construct more accurate models. The models themselves are quite simplified, and neglect many factors necessary to create a realistic model - in particular, the difference between thermal layers dominated by convection and those dominated by conduction\footnote{Sadly, the author was not able to figure out how to implement this before the final report deadline.}. In future research, these models could perhaps be expanded to include more than 3 layers, and thermal effects such as tidal heating or radiogenic heating.\\
Another potential issue of note is something that was briefly touched upon in Section \ref{sec:model1}: with the uncertainty ranges in the observational data used to constrain the models, there are likely multiple possible interior compositions. However, models I and by extension II output one set of parameters once the model converges. Thus, possible alternative parameter sets are neglected. A way to gain more insight into this would be to calculate the mass, moment of inertia, and mean density for a wide range of layer heights, and analyse the results to find regions within this space that match the observed values. This would, however, significantly increase the computational time.
