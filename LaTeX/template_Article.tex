...
\indent Running the program with these inputs results in the values shown in Table \ref{tab:results1}. Furthermore, the model predicts the pressure at the centre of Europa to be 5.26 GPa, which roughly agrees with the values in Table \ref{tab:modelcomparison}. The gravitational acceleration at the surface is found to be 1.32 m/s\textsuperscript{2}, which closely matches the value 1.31 m/s\textsuperscript{2} given by Cammarano et al.\cite{cammaranoLongperiodSeismologyEuropa2006}. The core radius and shell thickness found are 724 and 122 km, respectively, roughly resembling the models in Table \ref{tab:modelcomparison}, though not quite matching any of them. It takes the program 26 iterations to converge to these values.\\
...
\begin{table*}
	...
	\begin{tabular}{|>{\raggedright\arraybackslash}m{0.37\columnwidth}|>{\raggedright\arraybackslash}m{0.3\columnwidth}|>{\raggedright\arraybackslash}m{0.61\columnwidth}|>{\raggedright\arraybackslash}m{0.5\columnwidth}|}
		...
		\textbf{Mass} & 4.795*10\textsuperscript{22} kg & 1.840*10\textsuperscript{19} kg & 0.123 \\ \hline
		\textbf{Moment of inertia} & 0.341 & 0.0049 & 0.9829 \\ \hline
		\textbf{Mean density} & 3012.1 kg/m\textsuperscript{3} & 0.9 kg/m\textsuperscript{3} & 0.54 \\ \hline
	\end{tabular}
\end{table*}
...
\begin{table}[]
	...
	\centering
		\begin{tabular}{|>{\raggedright\arraybackslash}m{0.37\columnwidth}|>{\raggedright\arraybackslash}m{0.14\columnwidth}|>{\raggedright\arraybackslash}m{0.14\columnwidth}|>{\raggedright\arraybackslash}m{0.14\columnwidth}|}
			...
			\textbf{Mass deviation}             & 0.976\% & 0.941\% & 0.956\%  \\ \hline
			\textbf{Centre pressure [GPa]}      & 4.923   & 4.921   & 4.921 \\ \hline
			\textbf{Gravity at surface [m/s\textsuperscript{2}]} & 1.294 & 1.295 & 1.295 \\ \hline
			\textbf{Core radius [km]}           & 654    & 666    & 677    \\ \hline
			\textbf{Shell thickness [km]}       & 125    & 123    & 120    \\ \hline
			\textbf{MOI deviation}          & 0.0356\% & 0.0350\% & 0.0256\% \\ \hline
			\textbf{Iterations}                 & 54    & 66      & 77    \\ \hline
		\end{tabular}%
\end{table}
\begin{figure}[H]
	\centering
