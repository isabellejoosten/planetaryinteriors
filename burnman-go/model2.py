...
M_min, g_min, p_min, r_min, rho_min, T_min, core_boundary_min, mantle_boundary_min, inertia_min, simcount_min, core_mantle_boundary_pressure_min, mantle_shell_boundary_pressure_min, core_mantle_boundary_temp_min, mantle_shell_boundary_temp_min, core_mantle_boundary_gravity_min, mantle_shell_boundary_gravity_min = functions.iterate(M, g, p, r, rho, T_min)
...
M_mean, g_mean, p_mean, r_mean, rho_mean, T_mean, core_boundary_mean, mantle_boundary_mean, inertia_mean, simcount_mean, core_mantle_boundary_pressure_mean, mantle_shell_boundary_pressure_mean, core_mantle_boundary_temp_mean, mantle_shell_boundary_temp_mean, core_mantle_boundary_gravity_mean, mantle_shell_boundary_gravity_mean = functions.iterate(M, g, p, r, rho, T_mean)
...
M_max, g_max, p_max, r_max, rho_max, T_max, core_boundary_max, mantle_boundary_max, inertia_max, simcount_max, core_mantle_boundary_pressure_max, mantle_shell_boundary_pressure_max, core_mantle_boundary_temp_max, mantle_shell_boundary_temp_max, core_mantle_boundary_gravity_max, mantle_shell_boundary_gravity_max = functions.iterate(M, g, p, r, rho, T_max)
